...
namespace PokerServer.GameLogic.poker
{
    public class Round
    {
        ...
        public void startRound()
        {
            ...
            SmallBlind = 10 * (int)Math.Pow(2, (int)Math.Floor((float)(totalRounds / _players.Count)));
            BigBlind = 20 * (int)Math.Pow(2, (int)Math.Floor((float)(totalRounds / _players.Count)));
            // Post blinds
            // Dealer -> SB -> BB
